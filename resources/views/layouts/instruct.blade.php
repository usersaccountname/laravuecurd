...
<head>
    ...
    <title>Community School - Instructor</title>
...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            ...
            <!-- <a href="{{ route('ilogout') }}" class="nav_link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> -->
            <a href="{{ route('ilogout') }}" class="nav_link">
