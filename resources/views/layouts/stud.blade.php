...
<head>
    ...
    <title>Community School - Student</title>
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="/fees" class="nav_link">
                        <i class='bx bx-list-ol nav_icon'></i>
                        <span class="nav_name">Fees</span>
                    </a>
                </div>
            </div>
            <!-- <a href="{{ route('slogout') }}" class="nav_link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> -->
            <a href="{{ route('slogout') }}" class="nav_link">
